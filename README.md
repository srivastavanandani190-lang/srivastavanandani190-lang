...
<p align="center">
  <img src="https://skillicons.dev/icons?i=cpp,python,html,css,js,react,nodejs,mongodb,php,git,github,linux,bash,vscode,tailwind" />
</p>
...
| **🎨 Frontend Web Dev Projects** | UI Designs, Web Apps, Landing Pages | (https://amazonprojectns.netlify.app/) |
| **🎬 Moviify Website** | Movie search + recommendation + UI | (https://studio-gamma-lac.vercel.app/) |
| **🤖 Python AI/ML Scripts** | Basics to intermediate models | (------) |
